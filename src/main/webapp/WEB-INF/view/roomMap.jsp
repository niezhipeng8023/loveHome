...
<head>
    ...
    <script type="text/javascript" src="http://api.map.baidu.com/getscript?v=2.0&ak=vZRczN8WjwsZ7ZRpUvDwdsDGB8SNGNeV"></script>
        ...
        <div class="filter-wrap">
            <div class="container-sm">
                <div class="filter-board">
                    <div class="filter-hd"><span class="hd-item active"><i class="sprites icon-loc3"></i>地图找房</span><a href="${pageContext.request.contextPath}/rentout/findRentOut" class="hd-item by-map">条件找房</a></div>
                    <div class="filter-bd">
                        <div id="allmap"></div>
                    </div>
                </div>
