...
<head>
    ...
    <title>租房信息,单间出租,青年公寓出租-恋家短租</title>
    <meta name="keywords" />
        ...
        <div class="filter-wrap">
            <div class="container-sm">
                <div class="filter-board">
                    <div class="filter-hd"><span class="hd-item active">条件找房</span><a href="${pageContext.request.contextPath}/main/toShowMap" class="hd-item by-map"><i class="sprites icon-loc3"></i>地图找房</a></div>
                    <div class="filter-bd">
                        <form method="get" action="${pageContext.request.contextPath}/rentout/findRentOut">
                            <div class="search-too-box">
                                ...
                                <div class="search-tool">
                                    ...
                                    <input type="search" placeholder="请输入房屋内容条件进行查找" class="search-ipt" name="Info" id="search-ipt"/>
                               ...
                               <div class="filter-row">
                                    <span class="filter-label">房屋租金：</span>
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control bor3" id="minPriceBegin" maxlength="10" name="PriceBegin" placeholder="最低价格" style="width:30%;height:28px;float:left;">
										  ...
										  -
                                            ...
                                            <input type="text" class="form-control bor3" name="PriceEnd" maxlength="10" id="PriceEnd" placeholder="最高价格" style="width:30%;height:28px;">
                                        </div>
                ...
                <ul class="gallery">
                    <c:forEach items="${pageRentoutInfo.list}" var="pageRentout">
                        <li class="gallery-item">
                            ...
                            <div class="item-img"><a href="${pageContext.request.contextPath }/rentout/findRoomById/${pageRentout.rgId}" target="_blank"><img src="${pageContext.request.contextPath}/upload/${pageRentout.roomPicture}"  width="318" height="212" /></a></div>
                            <div class="item-desc">
                                <span class="item-tag item-tag-standard"></span>
                                <div class="item-text">为恋家统一标准化装修，多属房龄较短的电梯公寓，在裸房基础上完成精装全配。</div>
                                <a href="${pageContext.request.contextPath }/rentout/findRoomById/${pageRentout.rgId}" target="_blank" title="短租3个月丨 可月付丨 ${pageRentout.roomDesc}" class="item-tit">${pageRentout.roomAddress} 短租3个月丨 可月付丨${pageRentout.roomDesc}</a>
                            </div>
                            <div class="item-info">
                        ...
                        <ul class="pagination">
                            ...
                            <li>
                                <c:if test="${pageRentoutInfo.hasPreviousPage}">
                                    <a href="${ pageContext.request.contextPath }/rentout/findRentOut?pageNo=${pageNum-1}" aria-label="Previous">
                            ...
                            <c:forEach items="${pageRentoutInfo.navigatepageNums}" var="page_num">
                                ...
                                <c:if test="${page_num != pageRentoutInfo.pageNum}">
                                    <li><a href="${ pageContext.request.contextPath }/rentout/findRentOut?pageNo=${page_num}">${page_num}</a></li>
                                </c:if>
                            </c:forEach>
                            <li>
                                <c:if test="${pageRentoutInfo.hasNextPage}">
                                    <a href="${ pageContext.request.contextPath }/rentout/findRentOut?pageNo=${pageNum+1}" aria-label="Next">
                                        <span aria-hidden="true">&raquo;</span>
                                    </a>
                                </c:if>

                            </li>
                            <li><a href="${ pageContext.request.contextPath }/rentout/findRentOut?pageNo=${pageRentoutInfo.pages}">末页</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
