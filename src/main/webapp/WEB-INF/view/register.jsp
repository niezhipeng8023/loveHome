    ...
    function reg() {
        ...
        if (password != passwordAgain){
            ...
            $.post("${pageContext.request.contextPath}/user/reg",
                {"username":username,"phone":phone,"password": password,"verifyCode" : verifyCode},
                function (data) {
                    if(data.state == 1){
        ...
        <form method="post" id="loginForm" >
            ...
            <div class="fields">
                <div class="form-field">
                    <label><input type="text" autocomplete="off" placeholder="设置用户名" name="username" class="field-ipt" id="username" value="" onblur="uname()">
                ...
                <div class="form-field">
                    <label>
                        <input autocomplete="off" class="field-ipt" data-val="true" data-val-phone="手机号格式不正确" data-val-required="请输入手机号" id="Phone" name="phone" placeholder="请输入手机号" type="text" value="" onblur="checkPhone()" />
                    </label>
                    <span class="msg-defalult" id="Phone-error-text" style="text-align: center" />
                </div><br>
                <div class="form-field">
                    <label><input type="password" autocomplete="off" placeholder="设置密码" name="password" class="field-ipt" id="password" value="" ><i class="icon-eye js-toggle-pwd"></i></label>
                    <span class="msg-defalult" id="password-error-text" style="text-align: center" />
                </div><br>
                <div class="form-field">
                    <label><input type="password" autocomplete="off" placeholder="确认密码" name="passwordAgain" class="field-ipt" id="passwordAgain" value=""><i class="icon-eye js-toggle-pwd"></i></label>
                    <span class="msg-defalult" id="passwordAgain-error-text" style="text-align: center" />
                </div><br>

                <div class="form-field" id="verify-code">
                     <input type="text" placeholder="请输入验证码" class="field-ipt field-get-code" name="verifyCode" id="verifyCode"  value="" autocomplete="off" aria-required="true" aria-invalid="false">
                   <%-- <a  class="get-code" id="getCode" onclick="getCode()">发送验证码</a><span class="msg-defalult" id="code-error-text" style="text-align: center" />--%>
                    <input type="button" class="btn btn-lg btn-blue btn-contact btn-valid" id="getCode" value="获取验证码" onclick="sendCode(this)" /> <br><span class="msg-defalult" id="code-error-text" style="text-align: center" />
                </div>
                ...
                <div class="extra">
                    <div class="extra-left" style="color:#36353A;text-align:center;font-size:12px">
                        ...
                        同意<a href="javascript:;"  class="site-protocol js-open-modal" data-target="#modal-protocol">《恋家短租服务条款》</a>
                    </div>
    ...
    <div class="modal js-modal protocol-modal" id="modal-protocol">
        <div class="modal-inner">
            ...
            <div class="modal-content">
                ...
                <h4>
                    5． 用户在注册时应当选择稳定性及安全性相对较好的电子邮箱，并且同意接受并阅读恋家发往用户的各类电子邮件。如用户未及时从自己的电子邮箱接受电子邮件或因用户电子邮箱或用户电子邮件接收及阅读程序本身的问题使电子邮件无法正常接收或阅读的，只要恋家成功发送了电子邮件，应当视为用户已经接收到相关的电子邮件。电子邮件在发信服务器上所记录的发出时间视为送达时间。
