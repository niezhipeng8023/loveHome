            ...
            <form class="form-horizontal style-form"  method="post" action="" enctype="multipart/form-data" onSubmit="return myCheck(this)" >
                ...
                <div class="modal-body">
                    <div class="form-group" style="border:none;">
                        <span class="col-sm-2" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">租房标题:</span>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        <span class="col-sm-2" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">房屋需求:</span>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        <span class="col-sm-2" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">想住在哪:</span>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        ...
                        <span class="col-sm-2" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">入住时间:</span>
                        <div class="col-sm-4">
                            <input type="text" readonly="readonly"  value="" id="modal-liveTime" class="form-control">
                        </div>

                        <span class="col-sm-2" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">想住多大:</span>
                    ...
                    <div class="form-group" style="border:none;margin-top:30px;">
                        ...
                        <span class="col-sm-2" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">我的预算:</span>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button"  id="btn_push_files" onclick="updataModel(${rentGet.rgId})"  class="btn btn-round btn-primary">
                        保存
                    </button>
        ...
        <div class="main-right-inner">
            ...
            <div class="container-fluid">
                <div class="row">
                      ...
                      <!-- 上部放按钮的地方开始 -->
                      <form class="form-horizontal style-form" method="get" action="${pageContext.request.contextPath}/rentget/findAllRentget" style="margin-top:10px;text-align:center;">
                          <div class="form-group" style="border:none;margin-top:5px;">
                              <div class=" col-sm-3" style="float:left;">
                                  ...
                                  <button type="button" class="btn btn-success"    >
                                      <span class="glyphicon glyphicon-user" style="color: rgb(255,255,255); font-size: 12px;text-shadow: rgb(255,255,255) 0px 0px 0px; ">&nbsp;发布求租</span>
                                  </button>
                                  </a>
                          ...
                          <div class="form-group" style="border:none;">
                              ...
                              <div class=" col-sm-5" style="float:left;">
                                  ...
                                  <select class="form-control bor3" style="width:45%;font-size:12px;height:28px;"  name="getStatus" >
                          ...
                          <div class="form-group" style="border:none;">
                              ...
                              <div class=" col-sm-5" style="float:left;margin-left:40px;">
                                  ...
                                  <input type="text" name="userName" value="" class="form-control" style="width:45%;height:28px;float:left;">
                              </div>
                      ...
                      <table class="table ">
                          ...
                          <c:forEach items="${pageRentgetInfo.list}" var="pageRentget">
                              ...
                              <tr class="mylist">
                                  ...
                                  <td style="text-align:center;"><span style="color: #5bc0de;">${pageRentget.minPrice}</span>/<span style="color: #5bc0de;">${pageRentget.maxPrice}</span></td>
                                  ...
                                  <td style="text-align:center;"><fmt:formatDate value='${pageRentget.getCreateTime}' type='date' pattern='yyyy-MM-dd'/></td>
                                  <td style="text-align:center;">${pageRentget.user.name}</td>
                                  <td style="text-align:center;">
                                      <c:if test="${pageRentget.getStatus == 1}">
                                          <!-- 你根据原型图修改操作的地方 -->
                                          <button type="button" onclick="edit_btn(${pageRentget.rgId})" id="edit_btn" class="btn btn-primary btn-xs" data-toggle="modal" u-id="${pageRentget.rgId}"  ><i class="fa fa-pencil"></i>
                                              编辑
                                          </button>
                                          <a href="${pageContext.request.contextPath}/rentget/deleteRentGet/${pageRentget.rgId}"><button type="button" onclick="del_btn()"  class="btn btn-danger btn-xs"  ><i class="fa fa-pencil"></i>
                                              删除
                                          </button></a>
                                      </c:if>
                                     <c:if test="${pageRentget.getStatus == 0}">
                                      ...
                                      <a href="${pageContext.request.contextPath}/rentget/jihuoRentGet/${pageRentget.rgId}"><button type="button"  onclick="jihuo_btn()" class="btn btn-drak btn-xs"  ><i class="fa fa-pencil"></i>
                                             激活
                                      </button></a>
                                     </c:if>
                                  </td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <nav aria-label="Page navigation">
                                <ul class="pagination">
                                    <li><a href="${pageContext.request.contextPath }/rentget/findAllRentget?pageNo=1">首页</a></li>
                                    <li>
                                        <c:if test="${pageRentgetInfo.hasPreviousPage}">
                                            <a href="${ pageContext.request.contextPath }/rentget/findAllRentget?pageNo=${pageNum-1}" aria-label="Previous">
                                    ...
                                    <c:forEach items="${pageRentgetInfo.navigatepageNums}" var="page_num">
                                        ...
                                        <c:if test="${page_num != pageRentgetInfo.pageNum}">
                                            <li><a href="${ pageContext.request.contextPath }/rentget/findAllRentget?pageNo=${page_num}">${page_num}</a></li>
                                        </c:if>
                                    </c:forEach>
                                    <li>
                                        <c:if test="${pageRentgetInfo.hasNextPage}">
                                            <a href="${ pageContext.request.contextPath }/rentget/findAllRentget?pageNo=${pageNum+1}" aria-label="Next">
                                                <span aria-hidden="true">&raquo;</span>
                                            </a>
                                        </c:if>

                                    </li>
                                    <li><a href="${ pageContext.request.contextPath }/rentget/findAllRentget?pageNo=${pageRentgetInfo.pages}">末页</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
