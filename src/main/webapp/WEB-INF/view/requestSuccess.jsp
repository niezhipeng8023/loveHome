...
<div class="container" id="page-main">
    ...
    <div class="main-right">
        <div class="main-right-inner">
            ...
            <div class="meta-form">
                <span style="icon: auto;"><span style="text-align: center" class="glyphicon glyphicon-ok-circle" />&nbsp;申请成功，等待管理员审核。5秒后自动返回上一页，或者点击<a style="color: #0fa6a3" href="${pageContext.request.contextPath}/owner/pushRequestOwner">这里返回上一页</a></span>
            </div>
        </div>
