            ...
            <div class="meta-form">
                <div class="col-sm-12 go-rent">
                    ...
                    <c:if test="${empty userMessageByid.messages}">
                        <p style="text-align: center">您还未发布留言，现在就去说些你想说的吧！<a href="${pageContext.request.contextPath}/main/toShowPushMessage" class="btn btn-info cus">我要留言</a></p>

                    </c:if>
                    <c:if test="${not empty userMessageByid.messages}">
                        <h4 style="text-align: center;color: #0b0b0b;">尊敬的用户，你可以发布留言，留下你最想说的话...<a href="${pageContext.request.contextPath}/main/toShowPushMessage" class="btn btn-info cus">我要留言</a></h4>
                        <br>
                                                ...
                                                <li class="gallery-item">
                                                   <input type="hidden" id="uid" value="${user.id}" />
                                                    ...
                                                    <div class="item-desc">
                                                        ...
                                                        <a onclick="edit_btn(${message.messageId})" target="_blank"  style="text-align: left;float: left;" class="item-tit">${message.title}</a>

                                                        <button type="button" style="float: right;" onclick="del_btn(${message.messageId})"  class="btn btn-danger btn-xs"  ><i class="fa fa-pencil"></i>
                                                            删除
                                                        </button>
                                                    </div>
                                                    ...
                                                    <div class="item-info" style="text-align: left;float: left;">
                                                     ...
                                                     <br>
                                                    <div class="item-info" style="text-align: left;float: left;">
                                                        <div class="item-loc" style="text-align: right;float: right;">&nbsp;&nbsp;<span class="glyphicon glyphicon-phone-alt"></span>&nbsp;联系电话：<span>${message.mPhone}</span></div>

                                                    </div>
                                                    <br>
                                                    <div class="item-info" style="text-align: left;float: left;">
                                                        <div class="item-loc" style="text-align: right;float: right;">&nbsp;&nbsp;<span class="glyphicon glyphicon-calendar"></span>&nbsp;<span>发布时间：<fmt:formatDate value='${message.mCreateTime}' type='date' pattern='yyyy-MM-dd'/></span></div>
                                                    </div><br>
                                                    <div class="item-info" style="text-align: left;float: left;">
                                                        <div class="item-loc">&nbsp;&nbsp;<span class="glyphicon glyphicon-folder-close"></span>&nbsp;<span>留言内容： ${message.content}</span></div>
                                                    </div>
