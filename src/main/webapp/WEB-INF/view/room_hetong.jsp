                        ...
                        <div class="tab-pane connect in active" id="contact_mess">
                            <div class="about">
                                ...
                                <div class="about_list">
                                    <p>根据《中华人民共和国合同法》及有关规定，甲、乙双方在自愿、平等、互利的基础上，经协商一致，为明确双方之间的权利义务关系，就甲方将其合法拥有的房屋出租给乙方使用，乙方承租甲方房屋事宜，订立本合同。</p>
                                ...
                                <div class="about_list">
                                    ...
                                    <p>(2)乙方应爱护房屋内的设施，不得随意拆除和改建,如需装修或增减设备时，应事先征得甲方同意，其费用由乙方自理，对房屋及房屋内设施有损坏的，应修理、修缮完好或按市场价赔偿。</p>
