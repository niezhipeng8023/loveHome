            ...
            <div class="meta-form">
                <div class="col-sm-12 go-rent">
                        ...
                        <c:if test="${empty userRentGetByid.rentgets}">
                            <p style="text-align: center">您还未发布求租信息，现在就去寻找您的专属小窝吧！<a href="${pageContext.request.contextPath}/main/toShowPushRent" class="btn btn-info cus">我要发布求租</a></p>

                        </c:if>
                        <c:if test="${not empty userRentGetByid.rentgets}">
                        <h4 style="text-align: center;color: #0b0b0b;">尊敬的用户，你可以发布房屋求租，寻找你满意的小窝...<a href="${pageContext.request.contextPath}/main/toShowPushRent" class="btn btn-info cus">我要发布求租</a></h4>
                        <br>
                                            ...
                                            <c:forEach items="${userRentGetByid.rentgets}" var="pageRentget">
                                                ...
                                                <li class="gallery-item">
                                                    ...
                                                    <div class="item-desc">
                                                        ...
                                                        <a onclick="edit_btn(${pageRentget.rgId})" target="_blank"  style="text-align: left;float: left;" class="item-tit">${pageRentget.rgTitle}(${pageRentget.roomAddress}，${pageRentget.roomArea}平精装)</a>
                                                    </div>
                                                    ...
                                                    <div class="item-info" style="text-align: left;float: left;">
                                                        <div class="item-price" style="text-align: right;float: right;" ><span><sub>￥</sub>${pageRentget.minPrice}—${pageRentget.maxPrice}</span>元/月</div>
                                                    </div>
                                                    <div class="item-info" style="text-align: left;float: left;">
                                                        <div class="item-loc">&nbsp;&nbsp;<span class="glyphicon glyphicon-user"></span>
                                                            &nbsp;联系人：<span>${pageRentget.rgName}</span></div><br>
                                                    </div>
                                                    <div class="item-info" style="text-align: left;float: left;">
                                                        <div class="item-loc" style="text-align: right;float: right;"><span class="glyphicon glyphicon-phone-alt"></span>&nbsp;联系电话：<span>${pageRentget.rgPhone}</span></div>
                                                    ...
                                                    <div class="item-info" style="text-align: left;float: left;">
                                                        <div class="item-loc" style="text-align: right;float: right;">&nbsp;&nbsp;<span class="glyphicon glyphicon-calendar"></span>&nbsp;<span>预期入住时间：<fmt:formatDate value='${pageRentget.getCreateTime}' type='date' pattern='yyyy-MM-dd'/></span></div>
                                                    </div>
                                                    <div class="item-info" style="text-align: left;float: left;">
                                                        <div class="item-loc">&nbsp;&nbsp;<span class="glyphicon glyphicon-folder-close"></span>&nbsp;<span>需求描述：${pageRentget.roomDesc}</span></div>
                                                    </div>
                                                   <button type="button" onclick="del_btn(${pageRentget.rgId})"  class="btn btn-danger btn-xs"  ><i class="fa fa-pencil"></i>
                                                        删除
                                                    </button>
                                                </li>
                                                </c:if>
