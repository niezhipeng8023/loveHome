        ...
        <div class="main-left-inner">
            <section class="left-item">
                ...
                <ul class="left-list">
                    ...
                    <li><a id="li4" href="${pageContext.request.contextPath}/rentout/findRentOut" target="_blank">我要租房</a></li>
                    <li><a id="li6" href="${pageContext.request.contextPath}/rentget/findRentget" target="_blank">求租列表</a></li>
                    <li><a id="li5" href="${pageContext.request.contextPath}/main/toShowPushMessage" target="_blank">我想留言</a></li>
            ...
            <section class="left-item">
                ...
                <ul class="left-list">
                    <li><a id="li21" href="${pageContext.request.contextPath}/userFind/toShowUserCenter/${user.id}">My Center</a></li>
                    <li><a id="li22" href="${pageContext.request.contextPath}/userFind/findId/${user.id}">我的求租</a></li>
                    <li><a id="li23" href="${pageContext.request.contextPath}/userFind/findUserMessageById/${user.id}">我的留言板</a></li>
