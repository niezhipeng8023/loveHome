...
<head>
    ...
    <title>求租房信息-恋家短租</title>
    <meta name="keywords" />
    <meta name="description" content="恋家短租成都租房网提供单间出租,宜家风格精装修的合租房.是成都年轻人喜爱的青年公寓,免费wifi,家具齐全,立即签约立即拎包入住.致力于为年轻人打造租房时代的美好回忆。" />
    ...
    <div class="page-main" id="page-main">
                    ...
                    <form class="form-horizontal style-form"  method="post" action="" enctype="multipart/form-data" onSubmit="return myCheck(this)" >
                        ...
                        <div class="modal-body">
                            <div class="form-group" style="border:none;">
                                <span class="col-sm-3" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">租房标题:</span>
                                <div class="col-sm-5">
                                    <input type="text" id="modal-title"  readonly="readonly" check-type="required"  value="" name="title" class="form-control">
                            ...
                            <div class="form-group" style="border:none;margin-top:30px;">
                                <span class="col-sm-3" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">房屋需求:</span>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group" style="border:none;margin-top:30px;">
                                ...
                                <span class="col-sm-3" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">我的预算:</span>
                                <span class="col-sm-6" id="modal-price" style="color:#5bc0de;font-size:16px;float:left;height:28px;text-align:left;line-height:28px;"></span>


                            </div>

                            <div class="form-group" style="border:none;margin-top:30px;">
                                <span class="col-sm-3" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">创建人:</span>
                                <div class="col-sm-3">
                                    <input type="text"  readonly="readonly" name="createName" check-type="required"  value="" id="modal-createName" class="form-control">
                                </div>

                                <span class="col-sm-3" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">想住多大:</span>
                                <span class="col-sm-3" id="modal-roomArea" style="color:#5bc0de;font-size:16px;float:left;height:28px;text-align:left;line-height:28px;"></span>

                            </div>

                            <div class="form-group" style="border:none;margin-top:30px;">
                                <span class="col-sm-3" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">联系电话:</span>
                                <div class="col-sm-4">
                                    <input type="text" name="mPhone"   readonly="readonly" value="" id="modal-mphone" check-type="required tel"  class="form-control">
                                </div>
                            ...
                            <div class="form-group" style="border:none;margin-top:30px;">
                                ...
                                <span class="col-sm-3" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">创建时间:</span>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group" style="border:none;margin-top:30px;">
                                <span class="col-sm-3" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">想住在哪:</span>
                                <div class="col-sm-6">
                            ...
                            <div class="form-group" style="border:none;margin-top:30px;">
                                ...
                                <span class="col-sm-3" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">入住时间:</span>
                                <div class="col-sm-4">
        ...
        <div class="filter-wrap">
            <div class="container-sm">
                <div class="filter-board">
                    ...
                    <div class="filter-bd">
                        ...
                        <div class="search-too-box">
                            ...
                            <div class="search-tool">
                                    ...
                                    <input type="search" placeholder="请输入标题/内容条件进行查找" class="search-ipt" name="Info" id="search-ipt">
                                    <input type="submit" value="搜索" class="search-btn js-search-btn" data-target="#search-ipt">
                        ...
                        <div class="filter-tags">
                            <div class="filter-row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text"  class="form-control bor3 contract_time_today" id="startLiveTime" name="startLiveTime" placeholder="起始时间" style="width:30%;height:28px;float:left;">
                                    ...
                                    <input type="text" class="form-control bor3 contract_time_today" name="endLiveTime" id="endLiveTime" placeholder="终止时间" style="width:30%;height:28px;">
                            ...
                            <div class="filter-row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control round-form" id="minPriceBegin" name="minPriceBegin" placeholder="最低价格" style="width:30%;height:28px;float:left;">
                                    ...
                                    <input type="text" class="form-control round-form" name="minPriceEnd" id="minPriceEnd" placeholder="最高价格" style="width:30%;height:28px;">
                            ...
                            <div class="filter-row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control round-form" id="maxPriceBegin" name="maxPriceBegin" placeholder="最低价格" style="width:30%;height:28px;float:left;">
                                    ...
                                    <input type="text" class="form-control round-form" name="maxPriceEnd" id="maxPriceEnd" placeholder="最高价格" style="width:30%;height:28px;">
                            ...
                            <div class="filter-row">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="rgName" value="" class="form-control" style="width:45%;height:28px;float:left;">
                                </div>
                    ...
                    <a class="new_email email-c" href="${pageContext.request.contextPath }/main/toShowPushRent" title="发布租房信息"></a>
                </div>
                 ...
                 <c:forEach items="${pageRentgetInfo.list}" var="pageRentget">
                    <li class="gallery-item">
                        ...
                        <div class="item-desc">
                            ...
                            <a onclick="edit_btn(${pageRentget.rgId})" target="_blank"  class="item-tit">${pageRentget.rgTitle}(${pageRentget.roomAddress}，${pageRentget.roomArea}平精装)</a>
                        </div>
                        <div class="item-info">
                            ...
                            <div class="item-loc"><span class="glyphicon glyphicon-phone-alt"></span>&nbsp;联系电话：<span>${pageRentget.rgPhone}</span></div>
                            <div class="item-price"><span><sub>￥</sub>${pageRentget.minPrice}—${pageRentget.maxPrice}</span>元/月</div>
                        </div>
                        <div class="item-info">
                            <div class="item-loc">&nbsp;&nbsp;<span class="glyphicon glyphicon-th-large"></span>&nbsp;<span>预期房屋面积：${pageRentget.roomArea}平方米</span></div>
                            <div class="item-loc">&nbsp;&nbsp;<span class="glyphicon glyphicon-calendar"></span>&nbsp;<span>预期入住时间：<fmt:formatDate value='${pageRentget.getCreateTime}' type='date' pattern='yyyy-MM-dd'/></span></div>
                        </div>
                        <div class="item-info">
                            <div class="item-loc">&nbsp;&nbsp;<span class="glyphicon glyphicon-folder-close"></span>&nbsp;<span>需求描述：${pageRentget.roomDesc}</span></div>
                        </div>
                    </li>
        ...
        <div class="container-sm">
            <div class="pagenation">
                <div class="col-md-6">当前第${pageRentgetInfo.pageNum}页,共${pageRentgetInfo.pages}页,共${pageRentgetInfo.total}条记录</div>
                <div class="col-md-6">
                        ...
                        <ul class="pagination">
                            ...
                            <li>
                                <c:if test="${pageRentgetInfo.hasPreviousPage}">
                                    <a href="${ pageContext.request.contextPath }/rentget/findRentget?pageNo=${pageNum-1}" aria-label="Previous">
                            ...
                            <c:forEach items="${pageRentgetInfo.navigatepageNums}" var="page_num">
                                ...
                                <c:if test="${page_num != pageRentgetInfo.pageNum}">
                                    <li><a href="${ pageContext.request.contextPath }/rentget/findRentget?pageNo=${page_num}">${page_num}</a></li>
                                </c:if>
                            </c:forEach>
                            <li>
                                <c:if test="${pageRentgetInfo.hasNextPage}">
                                    <a href="${ pageContext.request.contextPath }/rentget/findRentget?pageNo=${pageNum+1}" aria-label="Next">
                                        <span aria-hidden="true">&raquo;</span>
                                    </a>
                                </c:if>

                            </li>
                            <li><a href="${ pageContext.request.contextPath }/rentget/findRentget?pageNo=${pageRentgetInfo.pages}">末页</a></li>
                        </ul>
                    </nav>
                </div>
            </div>
