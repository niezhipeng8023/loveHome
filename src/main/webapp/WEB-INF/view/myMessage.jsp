                          ...
                          <div class="form-group" style="border:none;margin-top:5px;">
                              <div class=" col-sm-3" style="float:left;">
                                  <button type="button" class="btn btn-success"  onclick="jihuodecfm()" id="user_jihuo_all" >
                                      <span class="glyphicon glyphicon-user" style="color: rgb(255,255,255); font-size: 12px;text-shadow: rgb(255,255,255) 0px 0px 0px; ">&nbsp;添加</span>
                                  </button>
                              ...
                              <div class=" col-sm-4" style="float:left;">
                                  <span style="width:35%;color:#000;font-size:15px;float:left;height:28px;text-align:right;line-height:28px;">标题:</span>

                                  <input type="text" name="title" value="" class="form-control" style="width:45%;height:28px;float:left;">
