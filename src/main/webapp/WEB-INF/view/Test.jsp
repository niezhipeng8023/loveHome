			...
			<form class="form-horizontal style-form"  method="post" action="" enctype="multipart/form-data" onSubmit="return myCheck(this)" >
				...
				<div class="modal-body">
					<div class="form-group" style="border:none;">
						<span class="col-sm-2" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">用户名:</span>
						<div class="col-sm-6">
					...
					<div class="form-group" style="border:none;margin-top:30px;">
						<span class="col-sm-2" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">用户姓名:</span>
						<div class="col-sm-6">
					...
					<div class="form-group" style="border:none;margin-top:30px;">
						...
						<span class="col-sm-3" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">是否是房东:</span>
						<div class="col-sm-3">
					...
					<div class="form-group" style="border:none;margin-top:30px;">
						<span class="col-sm-2" style="color:#000;font-size:16px;float:left;height:28px;text-align:right;line-height:28px;">注册时间:</span>
						<div class="col-sm-4">
				...
				<div class="modal-footer">
					...
					<button type="button" id="btn_push_files" onclick="updataModel(${user.id})"  class="btn btn-round btn-primary">
						保存
					</button>
		...
		<div class="main-right-inner">
			...
			<div class="container-fluid">
				<div class="row">
					...
					<!-- 上部放按钮的地方开始 -->
					<form class="form-horizontal style-form" method="get" action="${pageContext.request.contextPath}/user/findAllUser" style="margin-top:10px;text-align:center;">
						<div class="form-group" style="border:none;margin-top:5px;">
							<div class=" col-sm-3" style="float:left;">
								<button type="button" class="btn btn-success"  onclick="jihuodecfm()" id="user_jihuo_all" >
									<span class="glyphicon glyphicon-user" style="color: rgb(255,255,255); font-size: 12px;text-shadow: rgb(255,255,255) 0px 0px 0px; ">&nbsp;全部激活</span>
								</button>


								<button type="button" class="btn btn-danger"  onclick="deledecfm()" id="user_delete_all" >
									<span class="glyphicon glyphicon-trash" style="color: rgb(255,255,255); font-size: 12px;text-shadow: rgb(255,255,255) 0px 0px 0px; ">&nbsp;全部禁用</span>
								</button>
							...
							<div class=" col-sm-4" style="float:left;">
								...
								<input type="text" name="usernameOrphone" value="" class="form-control" style="width:45%;height:28px;float:left;">
							...
							<div class=" col-sm-5" style="float:left;">
								...
								<div class="col-sm-7">
									<select class="form-control" style="width:45%;font-size:12px;height:28px;text-align: center;"  id="sex-find" name="sex" >
										<option value=""  selected="selected"  >请选择</option>
										<option value="1" >男</option>
										<option value="0" >女</option>
									</select>
						...
						<div class="form-group" style="border:none;">
							...
							<div class=" col-sm-4" style="float:left;margin-left:40px;">
								...
								<select class="form-control" style="width:45%;font-size:12px;height:28px;"  name="status" >
									<option value=""  selected="selected"  >请选择</option>
							...
							<div class=" col-sm-4" style="float:left;">
								...
								<select class="form-control" style="width:45%;font-size:12px;height:28px;"  name="isOwner">
									<option value=""  selected="selected"  >请选择</option>
							...
							<div class=" col-sm-3" style="float:left;">
								...
								<button type="submit" class="btn btn-round btn-warning" style="height:28px;text-align:center;line-height:28px;" onclick="sousuo()" >
							...
							<tr class="mylist">
								...
								<td style="text-align:center;">
									<c:if test="${page.status == 1}">
										<a href="${pageContext.request.contextPath }/user/deleteUser/${page.id}"><button class="btn btn-success btn-xs" onclick="deledecfm()" ><i class="fa fa-trash-o "></i>激活</button></a>

									</c:if>
									<c:if test="${page.status == 0}">
										<a href="${pageContext.request.contextPath }/user/jihuoUser/${page.id}"><button class="btn btn-drak btn-xs" onclick="jihuodecfm()" ><i class="fa fa-trash-o "></i>禁用</button></a>
									</c:if>
								</td>
								<td style="text-align:center;"><fmt:formatDate value='${page.createTime}' type='date' pattern='yyyy-MM-dd'/></td>

								<td style="text-align:center;">
									<!-- 你根据原型图修改操作的地方 -->
									<button type="button" onclick="edit_btn(${page.id})" id="edit_btn" class="btn btn-primary btn-xs" data-toggle="modal" u-id="${page.id}"  ><i class="fa fa-pencil"></i>
										编辑
									</button>
								</td>
							</tr>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<nav aria-label="Page navigation">
								<ul class="pagination">
									<li><a href="${pageContext.request.contextPath }/user/findAllUser?pageNo=1">首页</a></li>
									<li>
										<c:if test="${pageInfo.hasPreviousPage}">
											<a href="${ pageContext.request.contextPath }/user/findAllUser?pageNo=${pageNum-1}" aria-label="Previous">
									...
									<c:forEach items="${pageInfo.navigatepageNums}" var="page_num">
										...
										<c:if test="${page_num != pageInfo.pageNum}">
											<li><a href="${ pageContext.request.contextPath }/user/findAllUser?pageNo=${page_num}">${page_num}</a></li>
										</c:if>
									</c:forEach>
									<li>
										<c:if test="${pageInfo.hasNextPage}">
											<a href="${ pageContext.request.contextPath }/user/findAllUser?pageNo=${pageNum+1}" aria-label="Next">
												<span aria-hidden="true">&raquo;</span>
											</a>
										</c:if>

									</li>
									<li><a href="${ pageContext.request.contextPath }/user/findAllUser?pageNo=${pageInfo.pages}">末页</a></li>
								</ul>
							</nav>
						</div>
					</div>
...
<script>
    ...
    function updataModel(){
        ...
        $.post("${pageContext.request.contextPath}/user/updateManagerUserInfo",
            {"uid":updataModelUid,"uname": uname,"age" : age,"username" : username,"sex" : sex,"phone" : phone,"isOwner" : isOwner,"status" : status},
            function (data) {
                if (data.state == 1){
                    alert(data.message);
                    window.location.href = '${pageContext.request.contextPath}/user/findAllUser';
