        ...
        <div class="main-right-inner">
            ...
            <div class="container-fluid">
                ...
                <div class="switch-board row js-switch-board">
                    ...
                    <div class="col-sm-10 col-sm-offset-2">
                        <form action="" method="post" class="form-horizontal switch-item active" novalidate id="validate-form">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 pwd-box">
                                    <input type="password" autocomplete="off" class="form-control" placeholder="输入新登录密码" id="pswd" name="password">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 pwd-box">
                                    <input type="password" autocomplete="off" class="form-control" placeholder="请再次输入新登录密码" name="confirmPassword">
                                    <i class="ucenter_icon-pwd-show pwd-close js-toggle-pwd"></i>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6 pt40">
                                    <input type="button" class="btn btn-info cus" onclick="update()" value="提交" id="sub-btn">
                                </div>
                            </div>
                        </form>
