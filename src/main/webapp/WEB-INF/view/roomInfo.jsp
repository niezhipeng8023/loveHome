    ...
    <div class="page-main" id="page-main">
        ...
        <div class="container">
            <div class="breadcrumb mt30">
                <a href="${pageContext.request.contextPath}/main/toIndex">首页</a>&gt;<a href="${pageContext.request.contextPath}/rentout/findRentOut">我要租房</a>
            </div>
            ...
            <div class="prod-detail clearfix">
                    ...
                    <div class="img-viewer js-img-viewer">
                        <ul class="img-viewer-bg">
                            <c:if test="${empty rentOut.roomPicture}">
                                <li  class="cur"><a href="//image-etadmin-pub.uoko.com/images/room-lease-picture/2017-05-02/8a9fb2b5-2248-4ed8-91b9-0e5c7422bd1e.jpg?imageView2/2/w/880/h/447&amp;watermark/1/image/aHR0cDovL3d3dy51b2tvLmNvbS9zaHVpeWluLnBuZw==/gravity/Center" title="恋家短租"><img data-source="//image-etadmin-pub.uoko.com/images/room-lease-picture/2017-05-02/8a9fb2b5-2248-4ed8-91b9-0e5c7422bd1e.jpg?imageView2/1/w/450/h/300" src="${pageContext.request.contextPath}/img/loading.gif" width="450" height="300" class="exclude-lazy"></a></li>
                            </c:if>
                            <c:if test="${not empty rentOut.roomPicture}">
                                <li class="cur" ><img data-source="${pageContext.request.contextPath}/upload/${rentOut.roomPicture}" src="${pageContext.request.contextPath}/upload/${rentOut.roomPicture}" width="420" height="300" class="exclude-lazy"></li>
                            </c:if>

                         </ul>
                        <div class="img-viewer-sm">
                            <a href="javascript:;" role="button" class="sprites icon-arrow-left viewer-prev"></a><a href="javascript:;" role="button" class="sprites icon-arrow-right viewer-next"></a>
                            <ul class="img-viewer-list">
                                <c:if test="${empty rentOut.roomPicture}">
                                    <li  class= cur><img src="${pageContext.request.contextPath}/img/loading.gif" data-original="//image-etadmin-pub.uoko.com/images/room-lease-picture/2017-05-02/091e584b-9729-4b03-9ebe-6dc254dbc111.jpg?imageView2/1/w/66/h/44" width="66" height="44"></li>
                                    <li  class=><img src="${pageContext.request.contextPath}/img/loading.gif" data-original="//image-etadmin-pub.uoko.com/images/room-lease-picture/2017-05-02/091e584b-9729-4b03-9ebe-6dc254dbc111.jpg?imageView2/1/w/66/h/44" width="66" height="44"></li>
                                </c:if>
                                <c:if test="${not empty rentOut.roomPicture}">
                                    <li class= cur><img src="${pageContext.request.contextPath}/upload/${rentOut.roomPicture}" data-original="//image-etadmin-pub.uoko.com/images/room-lease-picture/2017-05-02/8a9fb2b5-2248-4ed8-91b9-0e5c7422bd1e.jpg?imageView2/1/w/66/h/44" width="66" height="44"></li>
                                    <li  class=><img src="${pageContext.request.contextPath}/img/loading.gif" data-original="//image-etadmin-pub.uoko.com/images/room-lease-picture/2017-05-02/091e584b-9729-4b03-9ebe-6dc254dbc111.jpg?imageView2/1/w/66/h/44" width="66" height="44"></li>
                                </c:if>
                ...
                <div class="detail-right">
                    <h2 class="detail-tit">【${rentOut.roomAddress}】<span id="loc-name">公交直达 地铁附近 ${rentOut.roomDesc}</span></h2>
                    ...
                    <div class="detail-table">
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-cont">
                                <address class="address col"><span class="sprites icon-loc2"></span>${rentOut.roomAddress}</address>
                            </div>
                        </div>
                        <div class="detail-row">
                        ...
                        <div class="detail-row no-border check_in_date">
                            ...
                            <div class="detail-cont"><fmt:formatDate value='${rentOut.outCreateTime}' type='date' pattern='yyyy-MM-dd'/></div>
                        </div>
                        ...
                        <div class="detail-row">
                            ...
                            <div class="detail-cont">
                                <div class="state-label-group" id="state-label-group">
                                        ...
                                        <div class="state-label" data-book-link="/MyUoko/BookingHouse/125FAAAA0A8B4BD8983203C437D80C86" data-is-short-rental="False" data-look-link="/room/reservation/125FAAAA0A8B4BD8983203C437D80C86" data-price="580" data-roomcode="A" data-roomid="125FAAAA0A8B4BD8983203C437D80C86" data-sign-link="/MyUoko/SignHouse/125FAAAA0A8B4BD8983203C437D80C86">
                        ...
                        <div class="btn-box">
                            <button id="look-link-old" onclick="showModel()" class="prefer-look-btn disabled"  data-toggle="modal" data-target="#staticBackdrop">我要租房</button>
            ...
            <div class="item-info-verbose" id="item-info-verbose">
                <div class="verbose-left">
                    <div class="left-block">
                        <div class="block-hd"><span class="sprites icon-detail-tit-label icon-sl-detail"></span>房间基本情况</div>
                        <div class="block-bd">
                            <ul class="house-info">
                                <li>
                                    <div class="info-left">
                                        <h2>${rentOut.roomStructure} <span class="size">${rentOut.roomArea}<i>㎡</i></span></h2>
                                        <div class="clearfix">
                                    ...
                                    <div class="info-right">
                                        <div class="house-tag">
                                            <span class="has-tips" title="有独立卫生间哦！"><i class="sprites icon-condition-check-sm "></i><b>独卫</b></span>
                                            <span class="has-tips" title="有飘窗哦！"><i class="sprites icon-condition-check-sm "></i><b>飘窗</b></span>

                                            <span class="has-tips" title="有空调哦！"><i class="sprites icon-condition-check-sm "></i><b>空调</b></span>
                                            <span class="has-tips" title="有采光很好很nice的阳台！"><i class="sprites icon-condition-check-sm "></i><b>阳台</b></span>
                                            <span class="time"></span>
                                        </div>
                                        <div class="house-config">
                                            【房间配置】 <span>床</span><span>衣柜</span><span>书桌</span><span>椅子</span><span>窗帘</span><span>灯具</span><span>四位挂钩</span><span>穿衣镜</span>
                                        </div>
                                    </div>
                            ...
                            <div class="common-prop">
                                ...
                                </table><a href="javascript:;" data-target="#qr-modal" class="show-weixin js-open-modal"></a>
                            </div>
                        </div>
                    </div>
                    <div class="left-block">
                        <div id="houseDetail" class="block-hd"><span class="sprites icon-detail-tit-label icon-sl-house"></span>房间详情</div>
                        <div class="block-bd">
                            <div class="detail-info-img"><img src="${pageContext.request.contextPath}/upload/${rentOut.roomPicture}" data-original="//image-etadmin-pub.uoko.com/images/room-lease-picture/2017-05-02/091e584b-9729-4b03-9ebe-6dc254dbc111.jpg?imageView2/1/w/330/h/220" width="330" height="220"><div class="info-img-desc"><p>ROOM</p><p><b></b></p></div></div>
                        </div>
                    </div>
                   <%-- <div class="left-block">
                    ...
                    <div class="left-block">
                        <div class="block-hd"><span class="sprites icon-detail-tit-label icon-sl-why"></span>为什么选择恋家？</div>
                        <div class="block-bd"><img src="${pageContext.request.contextPath}/img/uoko_advantage.png" data-original="${pageContext.request.contextPath}/img/uoko_advantage.png" width="861" height="643"></div>
                    </div>
                    <div class="left-block">
                        <div class="block-hd"><span class="sprites icon-detail-tit-label icon-sl-how"></span>怎么租房呐</div>
                        <div class="block-bd"><img src="${pageContext.request.contextPath}/img/how-to-rent.jpg" data-original="${pageContext.request.contextPath}/img/how-to-rent.jpg" width="804" height="124"></div>
                    </div>
                    <div class="left-block">
                        <div class="block-hd"><span class="sprites icon-detail-tit-label icon-sl-like"></span>猜你喜欢</div>
                        <div class="block-bd no-border AsyncLoading" data-url="/room/guessyoulike?communityId=dbcb5734402b4116ad6f1f85b3d93cec&amp;subAreaId=251">

                            <ul class="gallery">
                            <c:forEach items="${Likes}" var="pageRentout">
                                 <li class="gallery-item">
                                    <span class="sale-tag"></span>
                                    <div class="item-img"><a href="${pageContext.request.contextPath }/rentout/findRoomById/${pageRentout.rgId}" target="_blank"><img src="${pageContext.request.contextPath}/upload/${pageRentout.roomPicture}"  width="250" height="212" /></a></div>
                                    <div class="item-desc">
                                        <span class="item-tag item-tag-standard"></span>
                                        <div class="item-text">为恋家统一标准化装修，多属房龄较短的电梯公寓，在裸房基础上完成精装全配。</div>
                                        <a href="${pageContext.request.contextPath }/rentout/findRoomById/${pageRentout.rgId}" target="_blank" title="短租3个月丨 可月付丨 ${pageRentout.roomDesc}" class="item-tit">${pageRentout.roomAddress} 短租3个月丨 可月付</a>
                                    </div>
                                    <div class="item-info">
                ...
                <div class="verbose-right">
                    ...
                    <div class="around-hot AsyncLoading" data-url="/room/nearby?houseId=7B5B6CEF4C024DBF93E1DA6818F07004&amp;communityId=dbcb5734402b4116ad6f1f85b3d93cec">
                        <ul class="gallery">
        ...
        <div id="order-modal" class="modal js-modal order-modal">
            <div class="modal-inner">
                <h2 class="modal-hd">我要预约看房<br><small>APPOINTMENT FORM</small><%--<span class="close js-close">&times;</span>--%></h2>
        ...
        <div id="error-modal" class="modal js-modal order-modal">
            <div class="modal-inner">
                <h2 class="modal-hd">请登录<br><small>Error</small><span class="close js-close">&times;</span></h2>
                <div class="modal-content">
                    <p class="room_callback">
                        未登录!
                        <br>

                        <span class="room_callback_info">请您先<a href="${pageContext.request.contextPath}/main/toShowLogin">登录</a>。</span>
                    </p>
                   <%--
                    <div class="wx-media-group clearfix">
                        <div class="wx-icon">
                            <img src="${pageContext.request.contextPath}/img/uoko_wechat_qrcode.jpg" alt="扫一扫加入恋家短租官方微信，有机会赢取大奖！" class="img-responsive" />
                        </div>
                        <div class="wx-hint">
                            <h2>
                                下载官方租房社交APP<br />
        ...
        <div id="qr-modal" class="modal js-modal qr-modal">
            <div class="modal-content animate-y-in">
                <div class="container clearfix">
                    <div class="qr-modal-left"><img src="${pageContext.request.contextPath}/img/weixin_qr_popup.jpg" width="316" height="311"></div>
                    <div class="qr-modal-right">
                        <h2 class="qr-modal-title">掏出手机随时随地找房<br>PO地址推荐离你最近的优质房源</h2>
                        <p class="qr-modal-desc">更多优惠，好玩的。尽在微信：UOKOHOME。<br>你还没有关注吗？赶紧的！</p><a href="javascript:;" class="js-close qr-btn">我知道啦</a><img src="${pageContext.request.contextPath}/img/weixin_body_popup.gif" class="qr-picture">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="side-fix">
        <ul>
            ...
            <li class="side-weixin-box">
                ...
                <div class="side-desc">
                    <img src="${pageContext.request.contextPath}/img/footer-weixin-cd.jpg" width="131" height="131" alt="微信找房，扫我吧">
                    <p><b>微信找房</b>，扫我吧!</p>
                </div>
            </li>
