...
<div class="container" id="page-main">
    ...
    <div class="main-right">
        <div class="main-right-inner">
            ...
            <form action="${pageContext.request.contextPath}/owner/addRequestOwner" onsubmit="return checkForm()" class="form-horizontal" id="validate-form" method="post" enctype="multipart/form-data" role="form">
                <div class="meta-info">
                    ...
                    <div class="meta-form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 ">
                                <input class="form-control" id="ownerName" onblur="checkownerName()" check-type="required" name="ownerName" type="text" value="" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6 ">
                                <input class="form-control" id="ownerIdcard" check-type="required" name="ownerIdcard" onblur="checkIDCard()" type="text" value="" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <textarea class="form-control" id="requestDesc" onblur="checkrequestDesc()" check-type="required" name="requestDesc" type="text" value="" cols="20" rows="4" ></textarea>
