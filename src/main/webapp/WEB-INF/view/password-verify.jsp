            ...
            <div class="container-fluid">
                ...
                <div class="switch-board row js-switch-board">
                    ...
                    <div class="col-sm-10 col-sm-offset-2">
                        ...
                        <!--手机验证表单-->
                        <form action="${pageContext.request.contextPath}/user/updatePwd1" method="get" class="form-horizontal switch-item active" id="validate-form2" onsubmit="return checkForm()" >
                                ...
                                <div class="col-sm-6">
                                    <div class="input-group" style="width:345px;white-space:nowrap;" id="graph-hook">
                                        ...
                                        <c:if test="${not empty user.phone}">
                                           <h3> <span>您绑定的手机号码为：</span><span style="color: #0b0b0b" id="user_phone"></span></h3>
