                ...
                <div class="user-info-bar">
                    <div class="info-bar-meta">
                        <div class="info-bar-img">
                            <c:if test="${not empty user.hardIcon}">
                                <img src="${pageContext.request.contextPath}/upload/${user.hardIcon}" alt="" class="img-circle"  width="82" height="82" id="icon" >
                            </c:if>
                            <c:if test="${ empty user.hardIcon}">
                                <img src="${pageContext.request.contextPath}/img/default-male-avatar.png" id="icon" alt="" class="img-circle" width="82" height="82">
                            </c:if>
                    ...
                    <div class="row">
                        <c:if test="${empty user.idcard}">
                            <div class="col-sm-12 go-rent" style="text-align: center;">
                                ...
                                <p>您还不是房东不能发布房源，现在就去申请，就能发布您的小窝！<a href="${pageContext.request.contextPath}/owner/pushRequestOwner" class="btn btn-info cus">我要成为房东</a></p>
                            </div>
                        </c:if>
                        <c:if test="${not empty user.idcard}">
                            <c:if test="${empty userRentOutByid.rentouts}">
                                <p style="text-align: center">您还未发布房源，现在就去发布您的小窝！<a href="${pageContext.request.contextPath}/rentout/pushRoom" class="btn btn-info cus">我要发布房源</a></p>

                            </c:if>

                            <c:if test="${not empty userRentOutByid.rentouts}">
                                <h4 style="text-align: center;color: #0b0b0b;">尊敬的用户，你已经是<span style="color: #5bc0de">房东</span>，可以发布房源了<a href="${pageContext.request.contextPath}/rentout/pushRoom" class="btn btn-info cus">我要发布房源</a></h4>
                                <br>
