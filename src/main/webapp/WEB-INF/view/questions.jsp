...
<head>
    ...
    <title>出租房租前须知 - 恋家短租月租房疑问解答，非中介！</title>
    <meta name="keywords" />
                            ...
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal" style="text-indent:21.0pt;">
                                        <span>无中介费、宜家风格、精装全配、公寓式服务、网络社交平台——这是恋家短租的几个标签</span>
                                    </p>
                                    恋家短租成立于<span>2012</span>年，作为互联网时代新型租房模式的引领者，恋家为城市租房人群提供品质长租公寓产品，以及围绕租后服务和居住社交衍生的其他服务。我们以标准化的方式打造租住环境，更好的满足租客需求。运营四年来，我们一直努力践行“打造租房时代美好回忆”的品牌承诺，致力为都市年轻人打造更多样化的居住和社交生活体验。
                                    <p>
                                        <br />
                                    </p>
                                    <p>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        <span>&nbsp;<img src="http://images.uoko.com/Upload/EditorFiles/image/2016-08-05/00db6ff7-a2ea-4e05-b354-08f94c641022.png" alt="" /></span>
                                    </p>
                                    <p class="MsoNormal">
                                        <span>2.查看房源</span>
                                    </p>
                                    ...
                                    <h6>
                                        <img src="http://images.uoko.com/Upload/EditorFiles/image/2016-08-05/0711a15f-3472-4c2b-9228-cb24b99d8e48.png" alt="" /><br />
                                    </h6>
                                    <h6>
                                        <span style="font-weight:normal;line-height:1.5;">点击即可进入查看房屋具体信息</span>
                                    </h6>
                                    <p class="MsoNormal">
                                        <img src="http://images.uoko.com/Upload/EditorFiles/image/2018-08-23/f68cca05-e76b-44cd-94e8-440c0a319db4.png" alt="" />
                                    </p>
                                    <p class="MsoNormal">
                                        <br />
                                    </p>
                                    ...
                                    <p class="MsoNormal">
                                        &nbsp; &nbsp;不同的恋家短租管家会负责不同的区域，所以在预约时请告知清楚需求，让管家帮忙推荐可以最大限度节省宝贵的时间
                                    </p>
                                    <p class="MsoNormal">
                            ...
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        ...
                                        2、在线支付：<br />
                                        通过关注恋家短租官方微信（uokohome）或注册登录我们的官方网站，在【我的账单】列表查看账单并进行支付。<br />
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        三、<span style="line-height:1.5;">&nbsp;如果在长租期间工作地点发生变化，你可以选择顶租，直接将房间转租给下一位租客；或是选择换房，直接搬到离工作地点更近的恋家</span><span style="line-height:1.5;">房间，深受年轻人喜爱的恋家房间风格不愁顶，全城房源分布不愁换！</span>
                                    </p>
                            ...
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="p" style="margin-left:0.0000pt;">
                                        <img src="http://images.uoko.com/Upload/EditorFiles/image/2016-08-05/da949be2-7b14-47aa-92df-1a807468c48f.png" alt="" />
                                    </p>
                                    <p>
                                        <br />
                                    </p>
                            ...
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <div style="font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;">
                                        凡是恋家短租新签约租客，可领取20元蓝犀牛搬家抵金券（限蓝犀牛新注册用户）。
                                    </div>
                                    <div style="font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;">
                                        搬家券使用规则：
                                    </div>
                                    <div style="font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;">
                                        1、通过恋家短租官网及APP入口进入优惠券领取页面，填写手机及验证码，符合条件即可获得搬家券。
                                    </div>
                                    <div style="font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;">
                                    ...
                                    <p style="font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;">
                                        5、恋家短租为租客推荐租房搬家福利，具体搬家服务及责任均由蓝犀牛承担。
                                    </p>
                                    <p style="font-family:微软雅黑;font-size:14px;background-color:#FFFFFF;">
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal" style="margin-left:0cm;text-indent:0cm;">
                                        我们为所有合租房提供双周公区保洁服务。包括：<span style="font-family:微软雅黑, sans-serif;font-size:13.3333px;">公共区域厨房、公共区域卫生间及公共区域的墙面、地面及家具、家电表面的清洁和厨房、公共区域卫生间下水等。</span>
                                    </p>
                                    <p class="MsoNormal">
                                        <b>&nbsp;</b>
                                    </p>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        费用代收代缴服务旨在为每一位租客免去缴纳各种费用的烦恼，保障日常生活需求，专业的服务管家团队为您的居住生活提供强有力的后勤保障。目前代收代缴只适用部分房源。<span>&nbsp; </span><b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </b>
                                    </p>
                                    <p class="MsoNormal">
                                        <b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </b>
                                    </p>
                                    ...
                                    <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                        <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">序号</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                    </p>
                                    </td>
                                    <td width="72" style="border:solid black 1.0pt;">
                                        <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                            <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">服务内容</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                        </p>
                                    </td>
                                    <td width="470" style="border:solid black 1.0pt;">
                                        <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                            <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">服务标准</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                        </p>
                                    </td>
                                    </tr>
                                    <tr>
                                        <td width="72" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">1</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                        <td width="72" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">水气费</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                        <td width="470" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">由服务管家代缴，目前使用包干价收取。特殊房源除外。</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="72" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">2</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                        <td width="72" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">电费</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                        <td width="470" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">部分房源由服务管家代缴，每月抄录电表底度<span>/</span>余额，按照实际使用情况分摊至每人，每三个月由恋家收取一次费用。特殊房源除外。</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="72" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">3</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                        <td width="72" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">物业费</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                        <td width="470" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">由服务管家代缴，按照实际产生费用分摊至每个房间，每三个月由恋家收取一次费用。特殊房源除外。</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="72" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">4</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                        <td width="72" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">垃圾费</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                        <td width="470" style="border:solid black 1.0pt;">
                                            <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">由服务管家代缴，按照实际产生费用分摊至每个房间，每三个月收取一次费用。特殊房源除外。</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                            </p>
                                        </td>
                                    </tr>
                                    </tbody>
                                    ...
                                    <table class="MsoNormalTable ke-zeroborder" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td width="84" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">安全性检查</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                            <td width="461" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">检查灭火器是否过期、燃气、水阀、插座开关等是否存在安全隐患，若发现隐患及时处理</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="84" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">功能性检查</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                            <td width="461" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">检查冰箱、洗衣机，热水器、浴霸、门锁等是否能正常使用，若发现隐患及时处理</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="84" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">舒适性检查</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                            <td width="461" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">检查热水温度、重启光猫路由器、检查公区卫生情况，是否有养宠物等，若发现问题及时处理</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        1. 为了保证租客的咨询都能及时接待处理，我们不建议您找客服闲聊。客服通常的工作都很忙碌，因为要处理众多租客的事务性工作，我们希望您真正遇到问题的时候能及时联系到我们。<span></span>
                                    </p>
                                    <p class="MsoNormal">
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        关注恋家短租微信公众号<span>UOKOHome,</span>选择自主服务的投诉建议或联系10105288客服协助<span> &nbsp;&nbsp;&nbsp; </span>
                                    </p>
                                    <p class="MsoNormal">
                                        投诉单受理—了解核实投诉建议事实—协商处理方案—完成结单—微信回访<span>&nbsp; </span><b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </b>
                                    </p>
                                    <p class="MsoNormal">
                                        <b>&nbsp;</b>
                                    </p>
                                    ...
                                    <table class="MsoNormalTable ke-zeroborder" border="0" cellspacing="0" cellpadding="0">
                                        ...
                                        <tr>
                                            ...
                                            <td width="112" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">备用钥匙</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                            <td width="458" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">当您不小心忘记带钥匙时，其他租客也无法也联系不上，工作时间内可联系您的管家，去管家的办公驻点借用大门的备用钥匙并按时归还。非工作时间无法提供备用钥匙，请您谅解。</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="112" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">维修协调</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                            <td width="458" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">若是我们的房间出现工程质量问题，导致您无法居住，我们会为您提供一个临时的房间居住，满足您的基本居住需求</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="112" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">室友关系协调</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                            <td width="458" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">我们的服务宗旨是：为您创造租房时代的美好回忆。在您居住期间当您发现租客不符合筛查制，或者劝说后也不能遵守租客公约，可以致电<span>10105288</span>， 您的管家会进行上门协调；</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="112" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="center" style="text-align:center;vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">邻里关系协调</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                            <td width="458" style="border:solid black 1.0pt;">
                                                <p class="MsoNormal" align="left" style="vertical-align:middle;">
                                                    <span style="font-size:10pt;font-family:微软雅黑, sans-serif;">因房屋质量问题或生活习惯问题，导致邻里间投诉，我们会为及时介入，协调处理问题</span><span style="font-size:10pt;font-family:微软雅黑, sans-serif;"></span>
                                                </p>
                                            </td>
                                        </tr>
                                        </tbody>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        转租是指租客<span>A </span>要退租，但是找租客<span>B </span>来租住他的房间。即原承租人在承租合同到期前提出解约并自行找到该房屋的新租客的行为为转租。新租客需按当前的政策，与恋家短租重新签订承租合同。<span>&nbsp; </span><b>&nbsp;&nbsp;&nbsp; </b>
                                    </p>
                                    <p class="MsoNormal">
                                        <b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </b>
                                    </p>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        换房是指租客<span>A </span>从恋家短租“房间<span>X</span>”换到恋家短租“房间<span>Y</span>”，即承租期间，客户提出换到恋家短租的另外一间房子<b>&nbsp; &nbsp;&nbsp;&nbsp; </b>
                                    </p>
                                    <p class="MsoNormal">
                                        <b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </b>
                                    </p>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal">
                                        <b>二、流程<span>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; <br />
</span></b>确定是否续租——提前<span>3</span>天预约上门时间<span>---</span>管家上门办理续租手续<span>/</span>到期退租手续<b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </b>
                                    </p>
                                    <p class="MsoNormal">
                                        <b>&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; </b>
                                    </p>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="MsoNormal" style="margin-left:0cm;text-indent:0cm;" align="left">
                                        <!--[if !supportLists]-->1.<!--[endif]-->恋家短租（成都地区租客）于<span>2016</span>年<span>2</span>月<span>22</span>日起全面转为线上支付渠道收款；<span></span>
                                    </p>
                                    <p class="MsoNormal" style="margin-left:0cm;text-indent:0cm;" align="left">
                                        <!--[if !supportLists]-->2.<!--[endif]-->通过银联代扣实现房租、管理费、水电气费的一卡代缴，让租客更贴近“现代化”，目前所有租客都积极参与我们的银联代扣项目，方便快捷。<span></span>
                                    </p>
                                    <p class="MsoNormal" align="left">
                                        &nbsp;
                                    </p>
                                    ...
                                    <p class="MsoNormal" align="left">
                                        2、恋家短租提供银联代扣服务，定期从客户提供的银联卡上扣除房屋租金及房屋产生的其他费用<span></span>
                                    </p>
                                    <p class="MsoNormal" align="left">
                                        <b>&nbsp;</b>
                                    </p>
                                    ...
                                    2、在<span>2016</span>年<span>2</span>月<span>22</span>日起，请勿转账至恋家短租支付宝和银行账户，感谢大家的支持！
                                    <p>
                                        <br />
                                    </p>
                                </div>
                        ...
                        <div class="media media-box">
                            <div class="media-body">
                                ...
                                <div class="content">
                                    ...
                                    <p class="p">
                                        <strong>恋家短租（成都地区租客）于2016年2月22日起全面启用线上支付渠道收款，届时同步停止使用转账渠道（包含支付宝和银行转账），更方便快捷的缴费方式看这里：</strong>
                                    </p>
                                    <p class="p">
                                        <strong>1、通过关注绑定恋家短租微信（uokohome）或者注册登录我们的官方网站，在【账单】列表查看账单并进行支付（支持信用卡）</strong>
                                    </p>
                                    <p class="p">
                                        <strong>2、恋家短租提供银联代扣服务，定期从客户提供的银联卡上扣除房屋租金及房屋产生的其他费用</strong>
                                    </p>
                                    <p class="p">
                                        <strong>特别提示：为了您的资金安全，在任何时间地点，请勿向任何非官方渠道获知的账号转账汇款，以免上当受骗。</strong>
                                    </p>
                                    <p class="p">
                                        <strong>在2016年2月22日后，请勿转账至恋家短租支付宝和银行账户，我公司将停止转账渠道的到账查询，感谢大家的支持！</strong>
                                    </p>
                                    <div>
                                        <strong><br />
                                        </strong>
