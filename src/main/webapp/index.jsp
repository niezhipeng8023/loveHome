    ...
    <div class="page-main" id="page-main">
            ...
            <div class="container clearfix">
                ...
                <div class="uoko-navbar-right login-box">
                    ...
                    <c:if test="${not empty user}">
                        <span><a style="color: #0fa39f" href="${pageContext.request.contextPath}/main/toShowUserCenter">${user.name}</a>,你好！ |  <a>退出</a></span>
                    </c:if>
        ...
        <div class="search-box">
            <div class="container">
                ...
                </div><a href="#" class="sprites icon-map search-by-map"><span class="text-hidden">地图找房</span></a>
                <div class="hot-area">
                    <span><b>热门区域：</b></span>
                </div>
            </div>
                ...
                <ul class="gallery">
                    ...
                    <li class="gallery-item">
                        ...
                        <div class="item-desc">
                            ...
                            <a href="/room/7b5b6cef4c024dbf93e1da6818f07004" target="_blank" title="华阳欧尚旁 天府四街五街附近 公交直达世纪城 软件园新希望华银美行中心嘉美地 " class="item-tit">天府新区 华阳 华阳欧尚旁 天府四街五街附近 公交直达世纪城 软件园新希望华银美行中心嘉美地</a>
                        </div>
                        <div class="item-info">
                    ...
                    <li class="gallery-item">
                        <div class="item-img">
                            <a href="" target="_blank"><img src="img/F1.jpg" data-original="//image-etadmin-pub.uoko.com/images/room-lease-picture/2015-09-08/62d26f99-a34d-4e32-83ad-ec4609477f11.jpg?imageView2/1/w/318/h/212" width="318" height="212"></a>
                        </div>
                        <div class="item-desc">
                            <span class="item-tag item-tag-standard"></span>
                            <div class="item-text">为恋家统一标准化装修，多属房龄较短的电梯公寓，在裸房基础上完成精装全配。</div>
                            <a href="/room/f29e21f648c042698f4deadc6c3705a6" target="_blank" title="公交车直达软件园 华府大道 非中介精装套四单间 " class="item-tit">高新区 华府 公交车直达软件园 华府大道 非中介精装套四单间</a>
                        </div>
                        <div class="item-info">
                    ...
                    <li class="gallery-item">
                        <div class="item-img">
                            <a href="" target="_blank"><img src="img/F1.jpg" data-original="//image-etadmin-pub.uoko.com/images/room-lease-picture/2016-12-02/b23dafab-6286-41df-9102-f39f0cfc8f30.jpg?imageView2/1/w/318/h/212" width="318" height="212"></a>
                        </div>
                        <div class="item-desc">
                            <span class="item-tag item-tag-standard"></span>
                            <div class="item-text">为恋家统一标准化装修，多属房龄较短的电梯公寓，在裸房基础上完成精装全配。</div>
                            <a href="/room/c625598d5f054d579480500f356f9297" target="_blank" title="羊犀立交内侧 步行直达2号线羊犀立交站、茶店子站 可直达市中心 " class="item-tit">金牛区 茶店子 羊犀立交内侧 步行直达2号线羊犀立交站、茶店子站 可直达市中心</a>
                        </div>
                        <div class="item-info">
                    ...
                    <li class="gallery-item">
                        <div class="item-img">
                            <a href="" target="_blank"><img src="img/F2.jpg" data-original="//image-etadmin-pub.uoko.com/images/room-lease-picture/2014-05-19/382b11d6-1cf3-4246-8165-046d184a81a5.jpg?imageView2/1/w/318/h/212" width="318" height="212"></a>
                        </div>
                        <div class="item-desc">
                            <span class="item-tag item-tag-deposit"></span>
                            <div class="item-text">为纯房东托管，恋家未进行装修改造。同样由恋家提供出租、管理并享受租后服务。</div>
                            <a href="/room/afd92c3a04f242c59e81a98f6343996e" target="_blank" title="二环快速公交BRT 东郊记忆附近 非中介精装套三 " class="item-tit">成华区 杉板桥 二环快速公交BRT 东郊记忆附近 非中介精装套三</a>
                        </div>
                        <div class="item-info">
                    ...
                    <li class="gallery-item">
                        <div class="item-img">
                            <a href="" target="_blank"><img src="img/F2.jpg" data-original="//image-etadmin-pub.uoko.com/images/room-lease-picture/2016-01-25/a3edbea5-49c5-4a96-85a6-da2a87d6cb23.jpg?imageView2/1/w/318/h/212" width="318" height="212"></a>
                        </div>
                        <div class="item-desc">
                            <span class="item-tag item-tag-standard"></span>
                            <div class="item-text">为恋家统一标准化装修，多属房龄较短的电梯公寓，在裸房基础上完成精装全配。</div>
                            <a href="/room/d55d0fc500d8473284d75d52e5cf58ac" target="_blank" title="西部智谷 力德时代 汇点 慧谷 大悦城上班首选 公交直达红牌楼 春熙路 精装合租 出门就是公交站 交通便利 " class="item-tit">武侯区 新双楠 西部智谷 力德时代 汇点 慧谷 大悦城上班首选 公交直达红牌楼 春熙路 精装合租 出门就是公交站 交通便利</a>
                        </div>
                        <div class="item-info">
                    ...
                    <li class="gallery-item">
                        <div class="item-img">
                            <a href="" target="_blank"><img src="img/F2.jpg" data-original="//image-etadmin-pub.uoko.com/images/room-lease-picture/2015-07-23/f31c2835-c660-452a-b19d-de6e584518bb.jpg?imageView2/1/w/318/h/212" width="318" height="212"></a>
                        </div>
                        <div class="item-desc">
                            <span class="item-tag item-tag-standard"></span>
                            <div class="item-text">为恋家统一标准化装修，多属房龄较短的电梯公寓，在裸房基础上完成精装全配。</div>
                            <a href="/room/1ea3b8824f894ed490812c0fb43c778c" target="_blank" title="4号线清江西路地铁口附近丨公交直达金沙车站 贝森路 西单商场上班首选 精装单间合租 非中介 " class="item-tit">青羊区 内光华 4号线清江西路地铁口附近丨公交直达金沙车站 贝森路 西单商场上班首选 精装单间合租 非中介</a>
                        </div>
                        <div class="item-info">
                    ...
                    <li class="gallery-item">
                        <div class="item-img">
                            <a href="" target="_blank"><img src="img/loading.gif" data-original="https://image.uoko.com/Room.1A3A0786.jpg?imageView2/1/w/318/h/212" width="318" height="212"></a>
                        </div>
                        <div class="item-desc">
                            <span class="item-tag item-tag-remake"></span>
                            <div class="item-text">为半标准优化装修，利用原房配置条件，在原装修基础上进行美化改造，房龄相对更长，多集中在成熟社区。</div>
                            <a href="/room/e4ec98e995414e4899dc2e2f6d3822c0" target="_blank" title="可月付！通气套一标间！欢乐颂 保利心语旁边！软件园！银泰城！ " class="item-tit">高新区 大源 可月付！通气套一标间！欢乐颂 保利心语旁边！软件园！银泰城！</a>
                        </div>
                        <div class="item-info">
                    ...
                    <li class="gallery-item">
                        <div class="item-img">
                            <a href="" target="_blank"><img src="img/loading.gif" data-original="https://image.uoko.com/Room.8722ED01.jpg?imageView2/1/w/318/h/212" width="318" height="212"></a>
                        </div>
                        <div class="item-desc">
                            <span class="item-tag item-tag-remake"></span>
                            <div class="item-text">为半标准优化装修，利用原房配置条件，在原装修基础上进行美化改造，房龄相对更长，多集中在成熟社区。</div>
                            <a href="/room/36e64962c7b84be1b3e0ff534032c596" target="_blank" title="标间套一！空调独卫通通有！香悦城 益州大道 生态苑 软件园 " class="item-tit">高新区 软件园 标间套一！空调独卫通通有！香悦城 益州大道 生态苑 软件园</a>
                        </div>
                        <div class="item-info">
                    ...
                    <li class="gallery-item">
                        <div class="item-img">
                            <a href="" target="_blank"><img src="img/loading.gif" data-original="//image-etadmin-pub.uoko.com/images/room-lease-picture/2016-11-30/cbd4c60d-57bc-47e8-b96a-510b9d2b563a.jpg?imageView2/1/w/318/h/212" width="318" height="212"></a>
                        </div>
                        <div class="item-desc">
                            <span class="item-tag item-tag-remake"></span>
                            <div class="item-text">为半标准优化装修，利用原房配置条件，在原装修基础上进行美化改造，房龄相对更长，多集中在成熟社区。</div>
                            <a href="/room/a28bf8d3856f4232acca95da5d74a5cf" target="_blank" title="苏坡公园旁 依靠西南财经大学 环境舒适 交通方便 配套齐全 无中介费 " class="item-tit">武侯区 外双楠 苏坡公园旁 依靠西南财经大学 环境舒适 交通方便 配套齐全 无中介费</a>
                        </div>
                        <div class="item-info">
